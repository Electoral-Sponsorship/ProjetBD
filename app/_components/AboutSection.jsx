import { FaUsers, FaLock, FaChartBar } from "react-icons/fa"; // Icônes
    ...
    <section className="bg-gray-100 py-20">
      <div className="container mx-auto px-4">
        ...
        <div className="relative">
          <div className="absolute w-1 bg-green-600 h-full left-1/2 transform -translate-x-1/2"></div>
          ...
          <div className="space-y-16">
            ...
            <div className="flex items-center justify-between">
              <div className="w-5/12 pr-16 text-left">
